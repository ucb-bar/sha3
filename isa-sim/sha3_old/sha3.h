  ...
  reg_t custom0(rocc_insn_t insn, reg_t xs1, reg_t xs2)
  {
    switch (insn.funct)
    {
      ...
      case 1: // setup msg length and run
        ...
        unsigned char* input = malloc(msg_len*sizeof(char));
...
void sha3_update(sha3_state *sctx, unsigned char *data, unsigned int len);

void sha3_final(sha3_state *sctx, unsigned char *out);
